...
if run_image_copy
    ...
    list_file = fullfile( config.outdir, 'allimgs.txt' );
    ...
    for i=1:NImages
        ...
        newimg_file = fullfile( config.outdir, [newimg_base '.jpg'] );
...
if run_labeling 
    ...
    for i=1:NImages
        ...
        % load proposal file
        load( fullfile( config.outdir, proplist{i} ) );
...
if run_feature_collection
    ...
    save( fullfile( config.outdir, 'MetaData' ), 'MetaData' );
